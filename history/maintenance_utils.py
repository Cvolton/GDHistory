...
def update_cached_fields():
    ...
    print("- Setting cache_search_available = True")
    do_search_cache_updating(Level.objects.filter( Q(is_public=True) | Q(online_id__lt=estimated_id) , hide_from_search=False, cache_search_available=False, cache_is_blank=False), True)
    print("- Setting cache_search_available = False")
    do_search_cache_updating(Level.objects.filter( Q(is_public=False, online_id__gte=estimated_id) | Q( hide_from_search=True) , cache_search_available=True), False)
