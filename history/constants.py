...
class MiscConstants:
	...
	COMMENT_RANGES = [0,170001,3200001,29550001,35000001,53000001,63214001,81395001,90000001,100000001,110000001,124421501, 132542001]
	ACCOUNT_COMMENT_RANGES = [0, 1000001, 2000001, 10750001, 38873001]
